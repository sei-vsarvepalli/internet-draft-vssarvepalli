...
# ICMP Messages from within the Tunnel
...
# Security Considerations
   ...
   Fullk comprehesive security considerations are captured {{!RFC6169}} that provide
   security guidelines for proper usage of tunneling under all circumstances.
...
This document draws heavily on the text of {{!RFC2003}}.  The indirect input of
